...
const html =
  ...
  <h2>Title 2</h2>
  <figure>
    <img src="img/pic2.jpg" alt="title_2"/>
    <figcaption>Caption 2</figcaption>
  </figure>
  <p>Donec dignissim tincidunt nisl, non scelerisque massa pharetra ut. Sed vel velit ante. Aenean quis viverra magna. Praesent eget cursus urna. Ut rhoncus interdum dolor non tincidunt. Sed vehicula consequat facilisis. Pellentesque pulvinar sem nisl, ac vestibulum erat rhoncus id. Vestibulum tincidunt sapien eu ipsum tincidunt pulvinar.</p>
</article>

<article className="card">
  <h2>Title 7</h2>
  <figure>
    <img src="thumbnails/pic7.jpg" alt="title_7"/>
    <figcaption>Caption 7</figcaption>
  </figure>
  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sodales enim eget leo condimentum vulputate. Sed lacinia consectetur fermentum. Vestibulum lobortis purus id nisi mattis posuere. Praesent sagittis justo quis nibh ullamcorper, eget elementum lorem consectetur. Pellentesque eu consequat justo, eu sodales eros.</p>
</article>

<article className="card">
  <h2>Title 8</h2>
  <figure>
    <img src="img/pic8.jpg" alt="title_8"/>
    <figcaption>Caption 8</figcaption>
  </figure>
  <p>Praesent eget cursus urna. Ut rhoncus interdum dolor non tincidunt. Sed vehicula consequat facilisis. Pellentesque pulvinar sem nisl, ac vestibulum erat rhoncus id. Vestibulum tincidunt sapien eu ipsum tincidunt pulvinar. Donec dignissim tincidunt nisl, non scelerisque massa pharetra ut. Sed vel velit ante. Aenean quis viverra magna.</p>
</article>

<article className="card">
  <h2>Title 4</h2>
  <figure>
    <img src="thumbnails/pic4.jpg" alt="title_4"/>
    <figcaption>Caption 4</figcaption>
  </figure>
  <p>Duis sodales enim eget leo condimentum vulputate. Sed lacinia consectetur fermentum. Vestibulum lobortis purus id nisi mattis posuere. Praesent sagittis justo quis nibh ullamcorper, eget elementum lorem consectetur. Pellentesque eu consequat justo, eu sodales eros. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
</article>

<article className="card">
  <h2>Title 5</h2>
  <figure>
    <img src="img/pic5.jpg" alt="title_5"/>
    <figcaption>Caption 5</figcaption>
  </figure>
  <p>Sed vel velit ante. Aenean quis viverra magna. Praesent eget cursus urna. Ut rhoncus interdum dolor non tincidunt. Sed vehicula consequat facilisis. Pellentesque pulvinar sem nisl, ac vestibulum erat rhoncus id. Vestibulum tincidunt sapien eu ipsum tincidunt pulvinar. Donec dignissim tincidunt nisl, non scelerisque massa pharetra ut.</p>
</article>

<article className="card">
  <h2>Title 1</h2>
  <figure>
    <img src="thumbnails/pic1.jpg" alt="title_1"/>
